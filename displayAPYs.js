...
quick_request.open("GET","https://api.coingecko.com/api/v3/simple/price?ids=quick&vs_currencies=usd",false);
quick_request.send(null);       
var quick_price = JSON.parse(quick_request.responseText)["quick"]["usd"];

var eth_request = new XMLHttpRequest();
eth_request.open("GET","https://api.coingecko.com/api/v3/simple/price?ids=ethereum&vs_currencies=usd",false);
